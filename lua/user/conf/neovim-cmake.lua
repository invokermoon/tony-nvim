...
require('cmake').setup({
  ...
  default_projects_path = tostring(Path:new(vim.loop.os_homedir(), 'Cmake-Projects')), -- Default folder for creating project.
  -- default_projects_path = tostring(Path:new('cmake_project')), -- Current directory
