local options = {
    ...
    --wildignorecase = true,  -- match files ignore case
    --wildignore = ".git,.hg,.svn,*.pyc,*.o,*.out,*.jpg,*.jpeg,*.png,*.gif,*.zip,**/tmp/**,*.DS_Store,**/node_modules/**,**/bower_modules/**",

    whichwrap = "<,>,[,],~",
    -- listchars we move to indent-blankline.lua
}
...
vim.cmd [[
hi Trail ctermbg=red  guibg=red guifg=red
match Trail /\s\+$/
]]
...
vim.cmd [[
    augroup hltrail
    autocmd!
    autocmd BufWinEnter <buffer> hi Trail ctermbg=red  guibg=red
    autocmd BufWinEnter <buffer> match Trail /\s\+$/
    augroup end
]]
